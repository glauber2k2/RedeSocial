...
interface PostProps { //pois como as props são um array pela desestruturação, teremos que tipar por array tb.
  author: {
    name: string;
    role: string;
    avatarUrl: string;
      ...
      <div className={styles.content}> 
         {content.map(line => {
          if (line.type === 'paragraph') {
            ...
            return <p key={line.content}><a href="https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwix99KHzPT7AhVPIbkGHRgfBxUQyCl6BAgZEAM&url=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3D_AdyjwGiRDg&usg=AOvVaw2ukaXq4hVAg3rnlxEZyANL">{line.content}</a></p>
          }
         })}
      </div>
